<<<<<<< H:/Repos/shmindmaster/synapse/src/api/prisma/migrations/20251203124542_shfirst/migration.sql
-- CreateExtension
...
-- CreateIndex
CREATE UNIQUE INDEX "vector_embeddings_path_key" ON "vector_embeddings"("path");

-- CreateIndex
CREATE INDEX "vector_embeddings_path_idx" ON "vector_embeddings"("path");

-- CreateIndex
CREATE INDEX "vector_embeddings_indexed_at_idx" ON "vector_embeddings"("indexed_at");

-- Note: IVFFlat index requires fixed dimensions, use HNSW for dimensionless vectors
-- This index will be created after first data insertion when dimensions are known
-- CREATE INDEX "vector_embeddings_embedding_idx" ON "vector_embeddings" 
-- USING hnsw (embedding vector_cosine_ops);

-- AddForeignKey
ALTER TABLE "audit_logs" ADD CONSTRAINT "audit_logs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
>>>>>>> C:/Users/SaroshHussain/.windsurf/worktrees/synapse/synapse-0a1ab70e/src/api/prisma/migrations/20251203124542_shfirst/migration.sql
