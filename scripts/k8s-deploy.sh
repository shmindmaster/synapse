...
export APP_SLUG DO_REGISTRY_URL APP_DOMAIN_BASE DATABASE_URL="${DATABASE_URL}" \
       ...
       SPEECH_STT_PROVIDER SPEECH_TTS_PROVIDER ELEVENLABS_API_KEY AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY AWS_REGION FIRECRAWL_API_KEY RESEND_API_KEY TAVILY_API_KEY CI=true
