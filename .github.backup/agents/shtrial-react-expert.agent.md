...
tools: ["changes", "codebase", "edit/editFiles", "extensions", "fetch", "findTestFiles", "githubRepo", "new", "openSimpleBrowser", "problems", "runCommands", "runTasks", "runTests", "search", "searchResults", "terminalLastCommand", "terminalSelection", "testFailure", "usages", "vscodeAPI", "context7-mcp/*", "tavily-mcp/*"]
---
...
**React Environment Loading:**
```typescript
// Load from repo root .env (generated from .env.shared template)
...
- **Design Systems**: Material UI, Shadcn/ui, Tailwind CSS, and custom design system architecture
