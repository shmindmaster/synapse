...
3. **SEARCH** - Use Context7 for library docs, tavily-mcp for web research and real-time information
4. **VERIFY** - Cross-reference multiple authoritative sources (Context7 + tavily-mcp results)
5. **ANSWER** - Use ONLY information from verified, current documentation

**If you skip steps 3-4, you are providing outdated/hallucinated information.**
...
- Use tavily-mcp search to find latest version and real-time package registry information if needed
...
**Enhanced Research**: Use tavily-mcp tools alongside Context7 for comprehensive web research, especially when Context7 doesn't have complete documentation or when you need real-time information, examples, or community patterns.
...
5. **Compare and inform:**
   ...
   ```
   # JavaScript Example
   📦 Current: React 19.2.0 (from your package.json)
   🆕 Latest:  React 19.2.0 (from npm registry)
   Status: Up to date!
...
```typescript
// If user has Next.js 16.x installed
get-library-docs({
...
3. **Provide migration analysis** (adapt template to the specific library/language):
   ...
   **JavaScript Example**:
   ...
   ```markdown
   ## React 19.0.0 → 19.2.0 Upgrade Guide
...
- **Reference versions**: "In Next.js 16..." not "In Next.js..."
...
4. Generate integrated solution showing:
   - Next.js 16 App Router API route structure
...
User: "I'm using Next.js 15, how do I create dynamic routes?"
...
3. Provide Next.js 15-specific routing patterns
4. Optionally mention: "Note: Next.js 16 introduced [changes] if you're considering upgrading"
