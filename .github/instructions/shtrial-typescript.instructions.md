...
- Use environment variables from `.env.shared` for all configuration
...
- Follow standard patterns from `.pendoah/platform/templates/typescript/`
...
- Read from `.env.shared` for all environment variables
