...
tools: ['vscode', 'execute', 'read', 'edit', 'search', 'web', 'context7-mcp/*', 'tavily-mcp/*', 'firecrawl-mcp/*', 'agent', 'todo']
---
...
- Using `context7-mcp/*` to access library documentation and best practices
- Using `tavily-mcp/*` for comprehensive web research, real-time information, and community patterns
- Using `firecrawl-mcp/*` for extracting and crawling web content when deep content analysis is needed
...
- "Research the latest Next.js 16 App Router patterns and best practices"
- "Find Prisma ORM patterns for PostgreSQL with pgvector"
- "Investigate React 19 Server Components implementation approaches"
