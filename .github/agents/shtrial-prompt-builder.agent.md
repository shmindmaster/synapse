...
- "Create a new Next.js prompt based on the README.md in /src/frontend"
- "Update the TypeScript prompt to follow the latest conventions from official documentation"
- "Analyze this GitHub repo and improve our coding standards prompt"
- "Use this documentation to create a deployment prompt"
- "Update the prompt to follow the latest conventions and new features for React 19"
<!-- </interaction-examples> -->
...
- "Research Next.js 16 conventions from Vercel's official repositories"
- "Find the latest Prisma best practices from Prisma repos"
- "Update our standards based on popular React 19 projects"
